	...
	<div class='container'>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						<form action="<?=base_url('master/satuan_list_insert')?>" class="form-horizontal" id="form_add_data" method="post">
							<h3 class='block'> Tambah </h3>
				                <div class="form-group">
				                    <label class="control-label col-md-3">Nama Satuan<span class="required">
				                    * </span>
				                    </label>
				                    <div class="col-md-6">
		...
		<div class="modal fade" id="portlet-config-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						<form action="<?=base_url('master/satuan_list_update')?>" class="form-horizontal" id="form_edit_data" method="post">
							<h3 class='block'> Edit </h3>
				                <div class="form-group">
				                    ...
				                    * </span>
				                    ...
				                    <div class="col-md-6">
				                    	<input hidden='hidden' type="text" name="satuan_id"/>
										...
										<td>
											...
											<?
												if ($row->status_aktif == 1 ) { ?>
									            	<a class='btn-xs btn red btn-active'><i class='fa fa-times'></i> </a>
									            <?}else{?>
									            	<a class='btn-xs btn blue btn-active'><i class='fa fa-play'></i> </a>
									            <?}
											?>
										</td>
									</tr>
...
jQuery(document).ready(function() {       
	...
	TableAdvanced.init();
   	...
   	$('#general_table').on('click', '.btn-edit', function(){
   		$('#form_edit_data [name=satuan_id]').val($(this).closest('tr').find('.id').html());
   	...
   	$('#general_table').on('click', '.btn-active', function(){
