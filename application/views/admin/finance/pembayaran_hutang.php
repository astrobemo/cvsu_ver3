								...
								<div id='rinci_<?=$baris->id?>' <?=$hidden;?>>
									<table class="table table-hover table-striped table-bordered">
										...
										<tbody>
											...
											foreach ($pembayaran_hutang_awal_detail[$baris->id] as $row) { ?>
												<tr>
													<td>
											...
											foreach ($pembayaran_hutang_detail[$baris->id] as $row) { ?>
												<tr>
													<td>
														<?=is_reverse_date($row->tanggal);?>
													</td>
											...
											<tr style='font-size:1.1em; background:#c2c2ff'>
												<td> <?$sisa_hutang=$total - ($subtotal_bayar + $baris->pembulatan);?></td>
